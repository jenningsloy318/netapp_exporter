...
License: MIT
URL:     https://github.com/jenningsloy318/netapp_exporter
...
This is an exporter that exposes information gathered from netapp storage system for use by the Prometheus monitoring system.
...
systemctl enable netapp_exporter || true
systemctl start netapp_exporter
exit 0
...
%config(noreplace) %{_sysconfdir}/prometheus/netapp_exporter.yml
